...
CsmStudioCompilerCli.exe -i "%maindir%%lang%\12.ass" -l %lang% -o "%maindir%%label%_5\BDMV\STREAM\%eppv1%.m2ts" -f %format% -r %rate% -t 00:10:00.000
CsmStudioCompilerCli.exe -i "%maindir%%lang%\13.ass" -l %lang% -o "%maindir%%label%_5\BDMV\STREAM\%eppv2%.m2ts" -f %format% -r %rate% -t 00:10:00.000
CsmStudioCompilerCli.exe -i "%maindir%%lang%\14.ass" -l %lang% -o "%maindir%%label%_5\BDMV\STREAM\%eppv3%.m2ts" -f %format% -r %rate% -t 00:10:00.000
mkdir "%maindir%%label%_5\BDMV\CLIPINF\"
move "%maindir%%label%_5\BDMV\STREAM\*.clpi" "%maindir%%label%_5\BDMV\CLIPINF\"

CsmStudioCompilerCli.exe -i "%maindir%%lang%\15.ass" -l %lang% -o "%maindir%%label%_6\BDMV\STREAM\%eppv1%.m2ts" -f %format% -r %rate% -t 00:10:00.000
CsmStudioCompilerCli.exe -i "%maindir%%lang%\16.ass" -l %lang% -o "%maindir%%label%_6\BDMV\STREAM\%eppv2%.m2ts" -f %format% -r %rate% -t 00:10:00.000
CsmStudioCompilerCli.exe -i "%maindir%%lang%\17.ass" -l %lang% -o "%maindir%%label%_6\BDMV\STREAM\%eppv3%.m2ts" -f %format% -r %rate% -t 00:10:00.000
mkdir "%maindir%%label%_6\BDMV\CLIPINF\"
move "%maindir%%label%_6\BDMV\STREAM\*.clpi" "%maindir%%label%_6\BDMV\CLIPINF\"

CsmStudioCompilerCli.exe -i "%maindir%%lang%\18.ass" -l %lang% -o "%maindir%%label%_7\BDMV\STREAM\%eppv1%.m2ts" -f %format% -r %rate% -t 00:10:00.000
CsmStudioCompilerCli.exe -i "%maindir%%lang%\19.ass" -l %lang% -o "%maindir%%label%_7\BDMV\STREAM\%eppv2%.m2ts" -f %format% -r %rate% -t 00:10:00.000
CsmStudioCompilerCli.exe -i "%maindir%%lang%\20.ass" -l %lang% -o "%maindir%%label%_7\BDMV\STREAM\%eppv3%.m2ts" -f %format% -r %rate% -t 00:10:00.000
mkdir "%maindir%%label%_7\BDMV\CLIPINF\"
move "%maindir%%label%_7\BDMV\STREAM\*.clpi" "%maindir%%label%_7\BDMV\CLIPINF\"

CsmStudioCompilerCli.exe -i "%maindir%%lang%\21.ass" -l %lang% -o "%maindir%%label%_8\BDMV\STREAM\%eppv1%.m2ts" -f %format% -r %rate% -t 00:10:00.000
CsmStudioCompilerCli.exe -i "%maindir%%lang%\22.ass" -l %lang% -o "%maindir%%label%_8\BDMV\STREAM\%eppv2%.m2ts" -f %format% -r %rate% -t 00:10:00.000
