...
CsmStudioCompilerCli.exe -i "..\[SUB]\tmp\24.ass" -l %lang% -o "..\..\%LABEL%_5\BDMV\STREAM\%eppv4%.m2ts" -f %format% -r %rate% -t 00:10:00.000
CsmStudioCompilerCli.exe -i "..\[SUB]\tmp\25.ass" -l %lang% -o "..\..\%LABEL%_5\BDMV\STREAM\%eppv5%.m2ts" -f %format% -r %rate% -t 00:10:00.000
